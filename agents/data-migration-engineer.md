...
description: Moves data from the legacy system into the new schema - extraction, transformation rules, load scripts, and reconciliation. Use for ETL work in replacement/migration projects. Pairs with legacy-analyst (source facts) and db-engineer (target schema). Not for schema design or app features.
