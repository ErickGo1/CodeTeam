...
description: Owns everything outside the application code - CI/CD pipelines, Dockerfiles, infrastructure-as-code, environment config, release automation. Use for pipeline changes, build/deploy failures, containerization, and environment setup. Do NOT use for application code.
