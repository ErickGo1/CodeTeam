---
name: code-reviewer
description: Reviews code changes before merge. Use after implementers and test-writer complete work on a feature. Read-only, never modifies files. Checks correctness, security, boundary violations, and compliance with the project brief.
---
